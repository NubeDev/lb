...
//! UI can show "pending → delivered (→ dead-letter)" for a real effect. No enqueue/mark/delete here —
//! those are the relay's job (the `workflow` service), never a user verb.
//!
