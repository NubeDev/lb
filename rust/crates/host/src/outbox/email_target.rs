...
//!
//! Its collaborators each own one thing: `email_message.rs` holds the shapes ([`EmailMessage`],
//! [`EmailMeta`], [`Disposition`]), `email_payload.rs` types the opaque payload string,
...
use super::email_attachment::resolve_attachments;
use super::email_content::content_for;
use super::email_message::{sanitize_message_id, Disposition, EmailMessage, EmailMeta};
