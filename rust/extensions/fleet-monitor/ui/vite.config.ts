...
// Build the fleet-monitor UI as a single ESM `remoteEntry.js` the shell dynamic-imports (ui-federation
...
// `extensions-ui/fleet-monitor/`, so the shell loads it at `/extensions/fleet-monitor/ui/remoteEntry.js`
