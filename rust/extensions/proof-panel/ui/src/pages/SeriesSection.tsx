...
/** The READ half: search a tag facet → list the matching series via `series.find`, select one → show
 *  its latest value via `series.latest`. Honest loading / empty / error states throughout — a denied
 *  (out-of-scope) call shows the error, never a fabricated list or value. */
export function SeriesSection() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Browse series</CardTitle>
      </CardHeader>
