...
/** A fresh default cell for `view` at grid key `i` with geometry `geom`. */
export function defaultCell(view: View, i: string, geom = { x: 0, y: 0, w: 8, h: 4 }): Cell {
  ...
  return {
    ...
    options: defaultOptionsForView(v),
